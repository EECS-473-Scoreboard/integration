...
void show_calib() {
    ...
    fb[LCD_RENDER_HEIGHT / 10 * LCD_RENDER_WIDTH + LCD_RENDER_WIDTH / 10] =
        0xFE;
    fb[LCD_RENDER_HEIGHT / 10 * LCD_RENDER_WIDTH * 3 + LCD_RENDER_WIDTH / 10] =
        0xFE;
    fb[LCD_RENDER_HEIGHT / 2 * LCD_RENDER_WIDTH + LCD_RENDER_WIDTH / 10] = 0xFE;
    fb[LCD_RENDER_HEIGHT / 10 * LCD_RENDER_WIDTH * 7 + LCD_RENDER_WIDTH / 10] =
        0xFE;
    ...
    fb[LCD_RENDER_HEIGHT / 10 * LCD_RENDER_WIDTH + LCD_RENDER_WIDTH / 10 * 3] =
        0xFE;
    fb[LCD_RENDER_HEIGHT / 10 * LCD_RENDER_WIDTH * 3 +
       LCD_RENDER_WIDTH / 10 * 3] = 0xFE;
    fb[LCD_RENDER_HEIGHT / 2 * LCD_RENDER_WIDTH + LCD_RENDER_WIDTH / 10 * 3] =
        0xFE;
    fb[LCD_RENDER_HEIGHT / 10 * LCD_RENDER_WIDTH * 7 +
       LCD_RENDER_WIDTH / 10 * 3] = 0xFE;
    fb[LCD_RENDER_HEIGHT / 10 * 9 * LCD_RENDER_WIDTH +
       LCD_RENDER_WIDTH / 10 * 3] = 0xFE;

    fb[LCD_RENDER_HEIGHT / 10 * LCD_RENDER_WIDTH + LCD_RENDER_WIDTH / 2] = 0xFE;
    fb[LCD_RENDER_HEIGHT / 10 * 3 * LCD_RENDER_WIDTH + LCD_RENDER_WIDTH / 2] =
        0xFE;
    fb[LCD_RENDER_HEIGHT / 2 * LCD_RENDER_WIDTH + LCD_RENDER_WIDTH / 2] = 0xFE;
    fb[LCD_RENDER_HEIGHT / 10 * 7 * LCD_RENDER_WIDTH + LCD_RENDER_WIDTH / 2] =
        0xFE;
    fb[LCD_RENDER_HEIGHT / 10 * 9 * LCD_RENDER_WIDTH + LCD_RENDER_WIDTH / 2] =
        0xFE;

    fb[LCD_RENDER_HEIGHT / 10 * LCD_RENDER_WIDTH + LCD_RENDER_WIDTH / 10 * 7] =
        0xFE;
    fb[LCD_RENDER_HEIGHT / 10 * LCD_RENDER_WIDTH * 3 +
       LCD_RENDER_WIDTH / 10 * 7] = 0xFE;
    fb[LCD_RENDER_HEIGHT / 2 * LCD_RENDER_WIDTH + LCD_RENDER_WIDTH / 10 * 7] =
        0xFE;
    fb[LCD_RENDER_HEIGHT / 10 * LCD_RENDER_WIDTH * 7 +
       LCD_RENDER_WIDTH / 10 * 7] = 0xFE;
    fb[LCD_RENDER_HEIGHT / 10 * 9 * LCD_RENDER_WIDTH +
